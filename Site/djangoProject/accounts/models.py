...
class Record(models.Model):
    ...
    outside_temperature = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
    outside_humidity = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
    weight = models.DecimalField(max_digits=8, decimal_places=2)
    voltage = models.DecimalField(max_digits=8, decimal_places=2)
    battery_current = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
    battery_power = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
    solar_voltage = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
    solar_current = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
    solar_power = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
